...
default_args = {
    'start_date': datetime(2023, 6, 19, 1),
    'owner': 'Airflow'
}

with DAG(dag_id='start_and_schedule_dag', schedule_interval="0 * * * *", default_args=default_args) as dag: # schedule_interval=timedelta(hours=1)
