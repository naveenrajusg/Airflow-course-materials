...
class TestDagValidation:
    ...
    REQUIRED_EMAIL = "naveenraju100@gmail.com"
    ...
    #the below line is written to skip the testing of below function, comment the line to test the function
    ...
    # the below line is written to skip the testing of below function
    @pytest.mark.skip(reason="not yet added to the DAGs")
    ...
    # to excecute run below line in cmd
    #pytest test_day_validation.py -v